...
import { Flex, Text, Button, Link } from '@allnext/uikit'
  ...
  return (
    <Flex flexDirection="column">
      ...
      >
        ...
        >
          <ColoredWordHeading text={headingTranslatedText} firstColor="secondary" />
          ...
          <Flex>
            ...
            {secondaryButton.external ? (
              <Link external href={secondaryButton.to} color={theme?.isDark ? 'gold' : 'primary'}>
