...
import { Heading, Flex, Text, LinkExternal } from '@allnext/uikit'
...
const Pools: React.FC = () => {
  ...
  const pools = useMemo(() => {
    return poolsWithoutAutoVault.filter((pool) => pool.indicationTokenPerBlock)
        ...
        <Flex justifyContent="space-between" flexDirection={['column', null, null, 'row']}>
          <Flex flex="1" flexDirection="column" mr={['8px', 0]}>
            ...
            <Heading scale="md" color="text">
              {t('Long term supporters can choose to lock tokens for a determined period for higher rewards')}
            </Heading>
            <Heading scale="md" color="text">
              {t('High APR, low risk.')}
            </Heading>
            <Heading scale="lg" color="text">
              {t('Want to have your own vault?')}
              <LinkExternal
                href="https://forms.gle/k4CAvP8eQpoT9gu26"
                bold={false}
                fontSize="22px"
          ...
          >
            <InfoLayout>
              ...
              <Text color="text">{t('Win even more NT referring Nort Vaults to new users!')}</Text>
              ...
              {!account && (
                <>
                  <Text color={theme.isDark ? 'secondary' : 'primary'} fontSize="22px">
      ...
      <Page>
        ...
        {showFinishedPools && (
          <Text fontSize="20px" color="failure" pb="32px">
            {t('These vaults are no longer distributing rewards. Please unstake your tokens.')}
          </Text>
        )}
